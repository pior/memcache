...
var _ Querier = (*clientQueries)(nil)

type clientQueries struct {
	executor func(ctx context.Context, req *meta.Request) (*meta.Response, error)
	stats    *clientStatsCollector
}

// Get retrieves a single item from memcache.
func (c *clientQueries) Get(ctx context.Context, key string) (Item, error) {
...
func (c *clientQueries) Set(ctx context.Context, item Item) error {
...
func (c *clientQueries) Add(ctx context.Context, item Item) error {
	// Build flags
	flags := []meta.Flag{
...
func (c *clientQueries) Delete(ctx context.Context, key string) error {
...
func (c *clientQueries) Increment(ctx context.Context, key string, delta int64, ttl time.Duration) (int64, error) {
