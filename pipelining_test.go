...
// 		commands = append(commands, NewGetCommand(fmt.Sprintf("key%d", i)).WithFlag(protocol.FlagKey, ""))
// 	}
...
// 	// 	"mg key4 v k O0005\r\n",
// 	// }
// 	// require.Equal(t, expectedCommands, receivedComands)

// 	expectedResponses := []*protocol.Response{
// 		{Flags: protocol.Flags{{Type: "O", Value: "0001"}}, Status: protocol.StatusHD},
// 		{Flags: protocol.Flags{{Type: "O", Value: "0002"}}, Status: protocol.StatusHD},
// 		{Flags: protocol.Flags{{Type: "O", Value: "0003"}}, Status: protocol.StatusHD},
// 		{Flags: protocol.Flags{{Type: "O", Value: "0004"}}, Status: protocol.StatusHD},
// 		{Flags: protocol.Flags{{Type: "O", Value: "0005"}}, Status: protocol.StatusHD},
// 	}
// 	for i := range numCommands {
// 		require.Equal(t, expectedResponses[i], commands[i].Response)
// 	}
